...
# Add brackets
gridExtra::grid.arrange(p %>% add_brackets(list(c("MP Type", "Zombie", "Costa Rican in PR"), 
...
gridExtra::grid.arrange(tmp) ## print the graph
